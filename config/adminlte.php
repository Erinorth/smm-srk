    ...
    */
    ...
    'menu' => [
            ...
            'submenu' => [
                ...
                [
                    ...
                    'submenu' => [
                        ...
                        [
                            'text' => 'In Office',
                            'url'  => 'onthejobtraining_offices',
                            'icon' => 'far fa-dot-circle',
                        ],
                        [
                            'text'    => 'Approved',
                            'url'     => 'onthejobtraining_approves',
                            'icon' => 'far fa-dot-circle',
                        ],
                        [
                            'text' => 'Record',
                            'url'  => 'onthejobtraining_records',
                            'icon' => 'far fa-dot-circle',
                        ],
                    ],
                ],
                [
                    'text' => 'Mobilization Plan',
                    'url'  => 'mobilizationplans',
                ],
                [
                    'text'    => 'Time Confirmed',
                    'url'  => 'time_confirmed',
            ...
            'submenu' => [
                ...
                [
                    ...
                    'submenu' => [
                        ...
                        [
                            'text' => 'Quality Safety and Health',
                            'url'  => 'QSH_departments',
                            'icon' => 'far fa-dot-circle',
                        ],
                    ],
        ...
        [
            ...
            'submenu' => [
                [
                    'text'    => 'ProjectType_Product',
                    'url'     => 'QSH_project_type_products',
                ],
            ],
        ],
    ],
        ...
        'Select2' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'js/select2-bootstrap4.js',
                ],
                [
                    'type' => 'css',
                    'asset' => true,
        ...
        'Full-Calendar' => [
            ...
            'files' => [
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => '//cdnjs.cloudflare.com/ajax/libs/fullcalendar/3.9.0/fullcalendar.min.css',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => '//cdnjs.cloudflare.com/ajax/libs/fullcalendar/3.5.1/fullcalendar.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/fullcalendar-plugins/scheduler/scheduler.min.js',
                ],
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'vendor/fullcalendar-plugins/scheduler/scheduler.min.css',
                ],
            ],
        ],
        'icheck-bootstrap' => [
