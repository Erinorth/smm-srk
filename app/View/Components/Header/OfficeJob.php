...
class OfficeJob extends Component
{
    public $officeId;
    /**
            ...
            <div class="card-body">
                <div class="container-sm">
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-2">
                        <h6>Job Name : {{ $officedetail->JobName }}</h6>
                        <h6>Type : {{ $officedetail->Type }}</h6>
                        <h6>Start Date : {{ $officedetail->StartDate }}</h6>
                        <h6>Remark : {{ $officedetail->Remark }}</h6>
                    </div>
                </div>
            </div>
        </div>
...
blade;
    ...
    {
        $officedetail = MilestoneOffice::find($this->officeId);
