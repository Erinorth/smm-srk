...
class Quarter extends Component
{
     ...
     * @return void
     */
    public function __construct($quarterId)
    {
            ...
            <div class="card-body">
                <div class="container-sm">
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-2">
                        @foreach ($quarterdetail as $value)
...
blade;
    ...
    {
        $quarterdetail = DB::select('SELECT annuals.StartOfAnnual, annuals.EndOfAnnual, semiannuals.StartOfSemiannual, semiannuals.EndOfSemiannual, quarters.StartOfQuarter, quarters.EndOfQuarter
            FROM (annuals INNER JOIN semiannuals ON annuals.id = semiannuals.annual_id) INNER JOIN quarters ON semiannuals.id = quarters.semiannual_id
            WHERE (((quarters.id)='.$this->quarterId.'))');
