...
class Annual extends Component
{
     ...
     * @return void
     */
    public function __construct($annualId)
    {
...
blade;
    ...
    public function annualdetail()
    {
        $annualdetail = DB::select('SELECT annuals.StartOfAnnual, annuals.EndOfAnnual
            FROM annuals
            WHERE (((annuals.id)='.$this->annualId.'))');
