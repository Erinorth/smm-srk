...
<?php $__env->startSection('title','Project Type-Product'); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\DataTable\DefaultDataTable::class, ['color' => '','collapseCard' => '','title' => 'Project Type-Product','collapseButton' => 'minus','tableId' => '']); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Modal\InputForm::class, ['nameID' => '','modalTitle' => 'Add New Project Type-Product']); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Input\Dropdown::class, ['title' => 'Project Type','nameId' => 'project_type_id']); ?>
<?php $component->withName('input.dropdown'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
            <option></option>
            <?php $__currentLoopData = $projecttype; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?> 
         ...
         <?php if (isset($component)) { $__componentOriginal8edc3f604ccf86198d552bab71204eb2a48b3274 = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Input\Dropdown::class, ['title' => 'Product','nameId' => 'product_id']); ?>
<?php $component->withName('input.dropdown'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
            ...
            <?php $__currentLoopData = $product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($value->id); ?>"><?php echo e($value->ProductName); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
         <?php if (isset($__componentOriginal8edc3f604ccf86198d552bab71204eb2a48b3274)): ?>
<?php $component = $__componentOriginal8edc3f604ccf86198d552bab71204eb2a48b3274; ?>
<?php unset($__componentOriginal8edc3f604ccf86198d552bab71204eb2a48b3274); ?>
...
<?php endif; ?> 
                 <?php if (isset($component)) { $__componentOriginal6c45c96de75fea92f5ca669b23310c721765280b = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\DataTable\ColumnScript::class, ['columnName' => 'ProductName']); ?>
<?php $component->withName('data-table.column-script'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\DataTable\CreateScript::class, ['nameID' => '','title' => 'Add New Project Type-Product']); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\DataTable\SubmitScript::class, ['nameID' => '','actionUrl' => 'QSH_project_type_products']); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\DataTable\EditScript::class, ['editName' => '','editUrl' => 'QSH_project_type_products']); ?>
...
<?php endif; ?> 
                 <?php if (isset($component)) { $__componentOriginal29fc1eba46b477c43acc345b92cdc726cbaadaf0 = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\DataTable\EditValueScript::class, ['name' => 'product_id']); ?>
<?php $component->withName('data-table.edit-value-script'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\DataTable\DeleteScript::class, ['deleteName' => '','url' => 'QSH_project_type_products']); ?>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\smm-srk\resources\views/QSHs/projecttypeproduct.blade.php ENDPATH**/ ?>