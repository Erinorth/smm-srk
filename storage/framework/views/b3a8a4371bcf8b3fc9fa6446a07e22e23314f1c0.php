...
<?php $__env->startSection('title','On the Job Training Plan'); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Card\DefaultCard::class, ['color' => '','collapseCard' => 'collapsed-card','title' => 'Master Plan','collapseButton' => 'plus']); ?>
...
<?php $component->withAttributes([]); ?>
        ...
        <div class="container text-center">
            <a href="<?php echo e(url('OJTmaster/2')); ?>" class="btnprn btn btn-info btn-sm">หบนม-ธ.</a>
        </div>
...
<?php $component = $__env->getContainer()->make(App\View\Components\DataTable\DefaultDataTable::class, ['color' => '','collapseCard' => '','title' => 'ตารางการอบรมในงาน (On the Job Training)','collapseButton' => 'minus','tableId' => '']); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\DataTable\ColumnScript::class, ['columnName' => 'Year']); ?>
...
<?php endif; ?> 
                 <?php if (isset($component)) { $__componentOriginal6c45c96de75fea92f5ca669b23310c721765280b = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\DataTable\ColumnScript::class, ['columnName' => 'print']); ?>
<?php $component->withName('data-table.column-script'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\smm-srk\resources\views/onthejobtrainings/plan.blade.php ENDPATH**/ ?>