...
@section('content_header')
    <h1 class="m-0 text-dark">Confined Spaces</h1>
@stop
...
@section('content')
    ...
    <x-data-table.default-data-table color="" collapse-card="" title="Confined Spaces"
    ...
    <x-modal.input-form name-i-d="" modal-title="Add New Confined Space Measurement">
        ...
        <x-input.text title="ผู้อนุญาต" name-id="Warrantor"/>

        <x-input.text title="ผู้ควบคุมงาน" name-id="Foreman"/>
    ...
    <x-content.upload-file-project name="confinedspace" project-i-d="{{$project->id}}"/>
@endsection
    ...
    <script>
        $(document).ready(function(){
            ...
            <x-data-table.data-table-script table-name="" ajax-url="">
                ...
                <x-data-table.column-script column-name="Warrantor">
                    orderable: false
                </x-data-table.column-script>
            ...
            <x-data-table.edit-script edit-name=""  edit-url="{{ url('/confinedspaces') }}">
                ...
                <x-data-table.edit-value-script name="Warrantor"/>
