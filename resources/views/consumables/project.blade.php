...
@section('content')
    ...
    @php
        $tabledata = [
            ['<a href="'. url('storage/user_manual/การใช้งาน consumable.pdf').'">การใช้งาน Consumable</a>',null]
        ];
    @endphp
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#amount').DataTable({
                ...
                serverSide: true,
                ajax:{
                    url: "{{ url('/consumable_amounts/') }}"+projectid,
                },
                columns: [
                    ...
                    <x-data-table.column-script column-name="CountOfconsumable_id"/>
                ],
