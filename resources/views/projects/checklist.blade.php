...
@section('content')
    ...
    <x-content.upload-file-project name="check_list" project-i-d="{{$project->id}}"/>

    @php
        $tabledata = [
            ['<a href="'. url('storage/user_manual/การใช้งาน check list.pdf').'">การใช้งาน check list</a>',null]
        ];
    @endphp
...
@section('js')
    <script>
        $(document).ready(function(){
            ...
            <x-j-s.upload-file-project name="check_list"/>
        });
    </script>
@endsection
