...
@section('content')
    ...
    <x-data-table.default-data-table color="" collapse-card="" title="On The Job Training"
    ...
    <x-modal.input-form name-i-d="" modal-title="Create On the Job Training">
        ...
        <x-input.dropdown title="Location" name-id="location_id">
            <option></option>
...
@section('js')
    <script>
        $(document).ready(function(){
            ...
            <x-data-table.submit-script name-i-d="" action-url="{{ url('/onthejobtraining_projects') }}">
            ...
            $(document).on('click', '.edit', function(){
                ...
                $('#form_result').html('');
                $.ajax({
                    url :"{{ url('/onthejobtraining_projects/') }}"+id+"/edit",
                    dataType:"json",
                    success:function(data)
                    {
            ...
            $(document).on('click', '.evaluate', function(){
                ...
                $('#form_result2').html('');
                $.ajax({
                    url :"{{ url('/onthejobtraining_projects/') }}"+evaluate_id+"/edit",
                    dataType:"json",
                    success:function(data)
                    {
            ...
            <x-data-table.delete-script delete-name="" url="{{ url('/onthejobtraining_projects') }}"/>
