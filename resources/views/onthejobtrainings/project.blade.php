...
@section('js')
    <script>
        $(document).ready(function(){
            ...
            <x-data-table.submit-script name-i-d="" action-url="onthejobtraining_projects">
            ...
            $(document).on('click', '.edit', function(){
                ...
                $('#form_result').html('');
                $.ajax({
                    url :"/onthejobtraining_projects/"+id+"/edit",
                    dataType:"json",
                    success:function(data)
                    {
            ...
            $(document).on('click', '.evaluate', function(){
                ...
                $('#form_result2').html('');
                $.ajax({
                    url :"/onthejobtraining_projects/"+evaluate_id+"/edit",
                    dataType:"json",
                    success:function(data)
                    {
            ...
            <x-data-table.delete-script delete-name="" url="onthejobtraining_projects"/>
