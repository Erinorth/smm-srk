    ...
    <table class="table table-striped table-bordered">
     <thead>
      <tr>
        ...
        <th width="38%" class="sorting" data-sorting_type="asc" data-column_name="ConsumableCode" style="cursor: pointer">ConsumableCode <span id="ConsumableCode_icon"></span></th>
