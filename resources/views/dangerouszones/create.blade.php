...
@section('content_header')
    <h1 class="m-0 text-dark">Dangerous Zone</h1>
@stop
...
@section('content')
    ...
    <x-data-table.default-data-table color="" collapse-card="" title="Dangerous Zone"
    ...
    <x-modal.input-form name-i-d="" modal-title="Add New Dangerous Zone Measurement">
...
@section('js')
    <script>
        $(document).ready(function(){
            ...
            <x-data-table.edit-script edit-name=""  edit-url="{{ url('/dangerouszones') }}">
