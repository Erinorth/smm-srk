...
@section('content')
    <table class="table table-borderless table-sm">
        ...
        <tr>
            <td class="text-center"><h5>ปี <u>{{ $year }}</u>เดือน <u>{{ $month }}</u></h5></td>
        </tr>
        <tr>
            <td class="text-center"><h6>ชื่องาน <u>{{ $project->ProjectName }}</u></h6></td>
        </tr>
    </table>
        ...
        <tbody>
            ...
            @foreach ($plan as $value)
                <tr>
                    ...
                    <td class="text-center">{{ $value->Project1 }}</td>
                    <td class="text-center">{{ $value->Project2 }}</td>
                    <td class="text-center">{{ $value->Project3 }}</td>
                    <td class="text-center">{{ $value->Project4 }}</td>
                    <td class="text-center">{{ $value->Project5 }}</td>
                    <td class="text-center">{{ $value->Project6 }}</td>
                    <td class="text-center">{{ $value->Project7 }}</td>
                    <td class="text-center">{{ $value->Project8 }}</td>
                    <td class="text-center">{{ $value->Project9 }}</td>
                    <td class="text-center">{{ $value->Project10 }}</td>
                    <td class="text-center">{{ $value->Project11 }}</td>
                    <td class="text-center">{{ $value->Project12 }}</td>
                    <td class="text-center">{{ $value->Project13 }}</td>
                    <td class="text-center">{{ $value->Project14 }}</td>
                    <td class="text-center">{{ $value->Project15 }}</td>
                    <td class="text-center">{{ $value->Project16 }}</td>
                    <td class="text-center">{{ $value->Project17 }}</td>
                    <td class="text-center">{{ $value->Project18 }}</td>
                    <td class="text-center">{{ $value->Project19 }}</td>
                    <td class="text-center">{{ $value->Project20 }}</td>
                    <td class="text-center">{{ $value->Project21 }}</td>
                    <td class="text-center">{{ $value->Project22 }}</td>
                    <td class="text-center">{{ $value->Project23 }}</td>
                    <td class="text-center">{{ $value->Project24 }}</td>
                    <td class="text-center">{{ $value->Project25 }}</td>
                    <td class="text-center">{{ $value->Project26 }}</td>
                    <td class="text-center">{{ $value->Project27 }}</td>
                    <td class="text-center">{{ $value->Project28 }}</td>
                    @if ( $dayinmonth >= 29 )
                        <td class="text-center">{{ $value->Project29 }}</td>
                    @endif
                    @if ( $dayinmonth >= 30 )
                        <td class="text-center">{{ $value->Project30 }}</td>
                    @endif
                    @if ( $dayinmonth == 31 )
                        <td class="text-center">{{ $value->Project31 }}</td>
                    @endif
