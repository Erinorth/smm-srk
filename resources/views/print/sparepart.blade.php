...
@section('content')
    <table class="table table-bordered table-sm">
        ...
        <tr>
            ...
            <td rowspan="2" class="text-center align-middle" style="width:25%"><h4>Spare Part List</h4></td>
    ...
    <table class="table table-bordered table-sm">
        <thead>
            <tr>
                ...
                <td class="text-center">Sparepart Name</td>
