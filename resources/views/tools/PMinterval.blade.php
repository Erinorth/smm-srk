...
@section('js')
    <script>
        $(document).ready(function(){
            ...
            <x-data-table.submit-script name-i-d="" action-url="tool_PM_intervals">
                <x-data-table.ajax-reload-script table-id=""/>
            </x-data-table.submit-script>

            <x-data-table.edit-script edit-name=""  edit-url="tool_PM_intervals">
            ...
            <x-data-table.delete-script delete-name="" url="tool_PM_intervals"/>
        });
    </script>
@endsection
