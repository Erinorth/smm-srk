...
@section('content')
    ...
    <x-data-table.default-data-table color="" collapse-card="" title="Inspected by Drone"
    ...
    <x-modal.input-form name-i-d="" modal-title="Add New Inspected by Drone">
...
@section('js')
    <script>
        $(document).ready(function(){
            ...
            <x-data-table.edit-script edit-name=""  edit-url="{{ url('/drones') }}">
