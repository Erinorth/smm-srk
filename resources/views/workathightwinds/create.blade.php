...
@section('content_header')
    <h1 class="m-0 text-dark">Work at Hight(Wind Turbine)</h1>
@stop
...
@section('content')
    ...
    <x-data-table.default-data-table color="" collapse-card="" title="Work at Hight"
    ...
    <x-content.upload-file-project name="work_at_hight_wind" project-i-d="{{$project->id}}"/>
@endsection
...
@section('js')
    <script>
        $(document).ready(function(){
            ...
            <x-data-table.submit-script name-i-d="" action-url="{{ url('/workathight_winds') }}">
                <x-data-table.ajax-reload-script table-id=""/>
            </x-data-table.submit-script>

            <x-data-table.edit-script edit-name=""  edit-url="{{ url('/workathight_winds') }}">
            ...
            <x-data-table.delete-script delete-name="" url="{{ url('/workathight_winds') }}"/>

            <x-j-s.upload-file-project name="work_at_hight_wind"/>
        });
    </script>
@endsection
