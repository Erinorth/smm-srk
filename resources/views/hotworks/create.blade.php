...
@section('content_header')
    <h1 class="m-0 text-dark">Hot Work</h1>
@stop
...
@section('content')
    ...
    <x-data-table.default-data-table color="" collapse-card="" title="Hot Work"
    ...
    <x-content.upload-file-project name="hot_work" project-i-d="{{$project->id}}"/>
@endsection
...
<script src="https://unpkg.com/ionicons@5.2.3/dist/ionicons.js"></script>
    <script>
        $(document).ready(function(){
            ...
            <x-data-table.edit-script edit-name=""  edit-url="{{ url('/hotworks') }}">
